...
public class SecondActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clevertapDefaultInstance.pushEvent("SecondActivity");
    ...
    protected void prepareDisplayView(CleverTapDisplayUnit unit) {
        ...
        TextView campaignTextView = findViewById(R.id.campaign_text_view);
        TextView triggerTextView = findViewById(R.id.trigger_text_view);
